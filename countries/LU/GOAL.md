...
2 site(s)**, or roughly 526 servers. The gap between what runs today and that
...
|---|---|---:|---:|---:|---:|---|
| 1 | Sovereign core | 136 | 0.3 | EUR 5 m | 16% | no |
| 2 | Security and defense | 198 | 0.5 | EUR 12 m | 55% | no |
| 3 | State record | 98 | 0.2 | EUR 6 m | 73% | no |
| 4 | Elective | 94 | 0.3 | EUR 9 m | 100% | no |
