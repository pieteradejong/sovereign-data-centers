...
| | |
|---|---|
| Governing instrument | Law on the Management of State Information Resources |
| Cloud certification | No national scheme; ISO 27001 |
| Data classification | Law on State and Official Secrets: Restricted / Confidential / Secret / Top Secret |
| Procurement route | CPO LT central purchasing organisation |
...
| | |
|---|---|
| Government cloud | Valstybes debesija (State Cloud) - operated by KVTC under the Ministry of National Defence in state data centres |
| Maturity | operational |
| Digital identity | eID / Mobile-ID / Smart-ID |
| In-country commercial regions | 0 |
| Interconnection | LIXP Vilnius/Kaunas; no own subsea (NordBalt fibre to SE) |
...
Against that starting point, the modelled sovereign core is **2.1 MW of design load across
3 site(s)**, or roughly 836 servers. The gap between what runs today and that
...
|---|---|---:|---:|---:|---:|---|
| 1 | Sovereign core | 250 | 0.5 | EUR 9 m | 19% | no |
| 2 | Security and defense | 352 | 0.9 | EUR 23 m | 67% | no |
| 3 | State record | 142 | 0.3 | EUR 8 m | 82% | no |
| 4 | Elective | 92 | 0.3 | EUR 9 m | 100% | no |

**Phase 1 is the number that matters: EUR 9 m for 0.5 MW,
