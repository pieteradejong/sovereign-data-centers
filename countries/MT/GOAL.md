...
| | |
|---|---|
| Governing instrument | National Digital Strategy 2022-2027; MITA operates central government IT |
| Cloud certification | No national scheme; ISO 27001 |
| Data classification | Classified-information handling under national security legislation, aligned to EU/NATO markings |
| Procurement route | Department of Contracts |
...
**Foreign jurisdiction exposure.** No in-country region; MITA runs a hybrid model with Azure for burst and SaaS
...
| | |
|---|---|
| Government cloud | MITA Government Hybrid Cloud (MITA data centre + Azure); National Digital Strategy 2022-2027 |
| Maturity | operational |
| Digital identity | Maltese eID (Identita) / MyIdentity |
| In-country commercial regions | 0 |
| Interconnection | No major IXP (transits Sicily/Milan); Malta-Sicily cables and power interconnector |
